...
const greeting = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/11WxcAHbaDN1H6Mqpj9OoOp59umRB_c7M/view?usp=sharing",
...
const educationInfo = {
  ...
  schools: [
  ...
  }, */
    {
      ...
      desc:
        " I've completed my graduation in the year 2017 at Rajiv Gandhi University of Knowledge Technologies in Metallurgical and Materials department with aggregate 7.51 CGPA.",
  ...
  experience: [
    {
      ...
      desc:
        "Currently I'm working on Gemini Internal Product Project on React Js.",
      descBullets: [
    ...
    },
    {
      ...
      desc:
        "I've worked on making websites and in order to fulfill the requirements.",
      descBullets: [
    ...
    },
    {
      ...
      desc:
        "I did an internship in Digital Gannet Solutions as Digital Marketing.",
         descBullets: [
